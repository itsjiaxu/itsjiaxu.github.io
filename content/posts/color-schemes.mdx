...
<div class="grid grid-cols-2 gap-4">
  <Image
    class="mb-0 mt-0"
    src={monoDarkLanding}
    alt="Nordlys landing page in dark mode with mono color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys landing page in light mode with mono color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys projects page in dark mode with mono color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys projects page in light mode with mono color scheme"
    data-img-embed
    data-action="zoom"
  />
</div>
...
<div class="grid grid-cols-2 gap-4">
  <Image
    class="mb-0 mt-0"
    src={nordDarkLanding}
    alt="Nordlys landing page in dark mode with nord color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys landing page in light mode with nord color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys projects page in dark mode with nord color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys projects page in light mode with nord color scheme"
    data-img-embed
    data-action="zoom"
  />
</div>
...
<div class="grid grid-cols-2 gap-4">
  <Image
    ...
    alt="Nordlys landing page in dark mode with aurora color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys landing page in light mode with aurora color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys projects page in dark mode with aurora color scheme"
    data-img-embed
    data-action="zoom"
  />
  <Image
    ...
    alt="Nordlys projects page in light mode with aurora color scheme"
    data-img-embed
    data-action="zoom"
  />
</div>
